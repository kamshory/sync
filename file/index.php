...
if (@$_GET['action'] == 'upload-sync-file') {
    ...
    (`sync_file_id`, `application_id`, `file_path`, `relative_path`, `file_name`, `file_size`, `time_create`, `time_upload`, `time_download`, `time_sync`, `status`) VALUES
    ('$sync_file_id', '$application_id', '$file_path', '$relative_path', '$file_name', '$file_size', '$time_create', '$time_upload', NULL, NULL, 0)
    ";
